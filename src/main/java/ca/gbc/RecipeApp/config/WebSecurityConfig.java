package ca.gbc.RecipeApp.config;
...
//        * Description:            setting up the security, password encoder, and access to different pages
//        *********************************************************************************
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.authorizeRequests()
                .antMatchers("/users", "/search", "/list", "/edit/*", "/save", "/new", "/planer").authenticated()
